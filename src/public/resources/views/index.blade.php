...
<form class="content__form" action="{{ route('contacts.confirm') }}" method="POST">
    ...
    <div class="form__group">
        ...
        <div class="content__form__name-input">
            <label><input class="gender-input" type="radio" name="gender" value="男性" {{ old('gender')=='男性' ? 'checked' : '' }}>男性</label>
            <label><input class="gender-input" type="radio" name="gender" value="女性" {{ old('gender')=='女性' ? 'checked' : '' }}>女性</label>
            <label><input class="gender-input" type="radio" name="gender" value="その他" {{ old('gender')=='その他' ? 'checked' : '' }}>その他</label>
        </div>
        @error('gender')
            <div class="form__error">{{ $message }}</div>
        @enderror
